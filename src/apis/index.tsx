...
export const calendarSignRebate = (userId?: string) => {
    try {
        return fetch(`${apiHostUrl}/api/v1/raffle/activity/calendar_check_in_rebate?userId=${userId}`, {
            method: 'POST',
            headers: {
...
export const isCalendarSignRebate = (userId?: string) => {
    try {
        return fetch(`${apiHostUrl}/api/v1/raffle/activity/is_check_in_and_rebate?userId=${userId}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
            }
